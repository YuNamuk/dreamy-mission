...
export const HOME_DEFAULT: HomeContent = {
  ...
  heroSub: '성공이 아닌 섬김을,\n나의 일이 아닌 하나님의 일하심을,\n선교는 사랑하는 것임을,\n배워갑니다.',
  journey: [
    { y: '2022', id: 'mongolia', desc: '밝은미래학교 협력 · 인턴 교사 파송 · 3P 교육' },
    { y: '2022', id: 'philippines', desc: '필리핀 드리미학교 건축 · 교사 훈련 · 학생 교육선교' },
    { y: '2023', id: 'cambodia', desc: 'NIBC 협력 · Dreamville 구상' },
    { y: '2024', id: 'indonesia', desc: 'CGA 교사 방한 연수 · 교육 세미나' },
    { y: '2025', id: 'india', desc: '방갈로르·마니푸르 학교 교류 · 교사교육' },
    { y: '2026', id: 'pakistan', desc: 'PGI 협력 · Dreamy School & College 설립 · 교사연수 82명' },
  ],
  taglines: {
    mongolia: '밝은미래학교와 협력하며 3P 페스티벌·교사연수로 몽골 공교육의 성장을 돕습니다.',
    philippines: '마닐라 빈민촌에 필리핀 드리미학교를 세우고, 쓰레기산 아이들과 교육으로 함께합니다.',
    cambodia: '씨엠립 겨자씨초등학교·유치원과 함께하며, 학교를 중심에 둔 Dreamville을 세웁니다.',
    indonesia: 'CGA와 교육 철학을 나누며 교사·학생 교류와 교육 지원으로 함께 자랍니다.',
    india: '방갈로르·나갈랜드·마니푸르의 학교와 동역하고, 한센인 이웃을 돌봅니다.',
    pakistan: 'PGI 캠퍼스에 Dreamy School & College를 세우고, 교사연수로 동역합니다.',
  },
  cardImages: {},
  draws: [
