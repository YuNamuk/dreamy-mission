  ...
  return (
    <main>
      ...
      <section className="section--wide staticpage" style={{ padding: '128px 48px 0' }}>
        ...
        {filter && <a className="abtn" href="/gallery" style={{ marginTop: 14, display: 'inline-flex' }}>← {locale === 'ko' ? '전체 갤러리' : 'All galleries'}</a>}
      </section>
      <section className="section--wide" style={{ padding: '26px 48px 40px' }}>
        <GalleryView
          seasons={seasons}
          names={names}
          ui={{
